package EPrints::Plugin::Screen::EPMC::OpenAccess;
...
sub action_enable
{
	...
	my $filename = $repo->config( "config_path" )."/workflows/eprint/default.xml";
        my $insert = EPrints::XML::parse_xml( $repo->config( "lib_path" )."/workflows/eprint/OpenAccess.xml" );
